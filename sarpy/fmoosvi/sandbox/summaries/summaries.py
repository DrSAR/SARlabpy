...
for k,v in master_sheet.iteritems():
    ...
    try:
        ...
        data1 = sarpy.Scan(master_sheet[k][key_list[2]][0]).adata[key_list[4]].data.get_data()
        data2 = sarpy.Scan(master_sheet[k][key_list[3]][0]).adata[key_list[4]].data.get_data()
...
for k,v in master_sheet.iteritems():
    ...
    try:
        try:
            ...
            data2 = sarpy.Scan(master_sheet[k][key_list[2]][0]).adata[key_list[3]].data.get_data()
            data1 = 0*data2
