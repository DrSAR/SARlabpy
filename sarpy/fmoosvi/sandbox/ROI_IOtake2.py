...
def generate_ROI(masterlist_name, data_label, adata_label = None, ioType = None, path = None, forceVal = False):
    ...
    if ioType == 'export':
        ...
        if adata_label is None and forceVal is True:
            raise IOError('Please specify an adata_label or remove the force flag')
        ...
        print("Please specify either 'import' or 'export' for the ioType!")
...
generate_ROI(ms, '0h-IR_A', ioType = 'import')
generate_ROI(ms, '24h-IR_A', ioType = 'import')