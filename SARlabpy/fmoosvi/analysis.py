...
def describe_object(class_object):
    ...
    try: # if patient, print studies
        ...
        try: # if multile studies, print study names and scans         
...
def calculate_AUC(scan_object, time = 60, pdata = 1):
    
    # Define and extract necessary parameters
    x_size = scan_object.visu_pars.VisuCoreSize[0]
    y_size = scan_object.visu_pars.VisuCoreSize[1]
    scan_object.visu_pars.VisuAcqPhaseEncSteps
